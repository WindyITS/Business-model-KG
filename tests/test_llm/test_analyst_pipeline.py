...
class AnalystPipelineRunnerTests(unittest.TestCase):
    ...
    def test_analyst_runner_builds_memo_then_graph_then_critique(self):
        ...
        self.assertIn("named offering family, suite, platform, or franchise", captured_messages[0][1]["content"])
        ...
        self.assertIn("review each top-level offering or offering family", captured_messages[1][1]["content"])
        ...
        self.assertIn("split franchise is still being represented as one blended node", captured_messages[1][1]["content"])
